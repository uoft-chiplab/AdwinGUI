...
#define  DIGPANEL_CHK_DIGRESET            8       /* control type: binary, callback function: CHKDIGRESET_CALLBACK */
#define  DIGPANEL_TEXTMSG                 9       /* control type: textMsg, callback function: (none) */
